...
> Auto-generiert von `gwdg probe` (gwdg-tools) — Stand **2026-08-06 08:15 UTC**.
...
| `deepseek-v4-flash` | 0.3s | 10 | Y | OK |
...
| `mistral-medium-3.5-128b` | 0.3s | 2 | Y | OK |
...
| `qwen3.5-122b-a10b` | 21.9s | 0 | Y | OK |
| `qwen3.5-397b-a17b` | 3.0s | 2 | Y | OK |
| `qwen3.6-27b` | 1.5s | 1 | Y | OK |
| `qwen3.6-35b-a3b` | 1.1s | 1 | Y | OK |
