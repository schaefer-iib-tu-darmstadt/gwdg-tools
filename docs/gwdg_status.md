...
> Auto-generiert von `gwdg probe` (gwdg-tools) — Stand **2026-08-24 07:01 UTC**.
...
| `deepseek-v4-flash-0731` | 0.9s | 0 | Y | OK |
...
| `mistral-medium-3.5-128b` | 29.9s | 1 | Y | OK |
| `openai-gpt-oss-120b` | 0.7s | 0 | Y | OK |
| `qwen3-30b-a3b-instruct-2507` | 0.3s | 0 | Y | OK |
| `qwen3-coder-next` | 0.2s | 0 | Y | OK |
| `qwen3-omni-30b-a3b-instruct` | 0.2s | 0 | ERR | OK |
| `qwen3.5-122b-a10b` | 2.3s | 0 | Y | OK |
| `qwen3.5-397b-a17b` | 4.7s | 1 | Y | OK |
| `qwen3.6-27b` | 5.0s | 1 | Y | OK |
| `qwen3.6-35b-a3b` | 1.5s | 0 | Y | OK |
