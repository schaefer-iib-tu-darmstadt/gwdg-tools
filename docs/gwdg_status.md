...
> Auto-generiert von `gwdg probe` (gwdg-tools) — Stand **2026-06-26 18:36 UTC**.
...
|---|--:|--:|:--:|:--:|
| `apertus-70b-instruct-2509` | 0.3s | 0 | Y | OK |
| `deepseek-r1-distill-llama-70b` | 2.8s | 0 | ERR | OK |
| `devstral-2-123b-instruct-2512` | 0.8s | 0 | Y | OK |
| `gemma-4-31b-it` | 0.2s | 0 | Y | OK |
| `glm-4.7` | 0.3s | 0 | Y | OK |
| `internvl3.5-30b-a3b` | 0.1s | 0 | ERR | OK |
| `medgemma-27b-it` | 0.7s | 0 | ERR | OK |
| `meta-llama-3.1-8b-instruct` | 0.6s | 0 | Y | OK |
| `mistral-large-3-675b-instruct-2512` | 1801.8s | 1 | ERR | ERR — Request timed out. |
| `openai-gpt-oss-120b` | 0.4s | 0 | Y | OK |
| `qwen3-30b-a3b-instruct-2507` | 0.1s | 0 | Y | OK |
| `qwen3-coder-30b-a3b-instruct` | 0.2s | 0 | Y | OK |
| `qwen3-omni-30b-a3b-instruct` | 0.4s | 0 | ERR | OK |
| `qwen3.5-122b-a10b` | 7.2s | 1 | Y | OK |
| `qwen3.5-397b-a17b` | 1.8s | 0 | Y | OK |
| `qwen3.6-35b-a3b` | 2.0s | 0 | Y | OK |
| `teuken-7b-instruct-research` | 0.4s | 0 | ERR | OK |
