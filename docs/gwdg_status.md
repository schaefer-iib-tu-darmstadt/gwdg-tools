...
> Auto-generiert von `gwdg probe` (gwdg-tools) — Stand **2026-07-06 10:37 UTC**.
...
|---|--:|--:|:--:|:--:|
| `apertus-70b-instruct-2509` | 0.4s | 1 | Y | OK |
| `devstral-2-123b-instruct-2512` | 0.3s | 0 | Y | OK |
| `gemma-4-31b-it` | 0.3s | 0 | Y | OK |
| `glm-4.7` | 0.5s | 0 | Y | OK |
| `medgemma-27b-it` | 0.6s | 1 | ERR | OK |
| `meta-llama-3.1-8b-instruct` | 0.7s | 0 | Y | OK |
| `mistral-large-3-675b-instruct-2512` | 245.8s | 1 | Y | OK |
| `openai-gpt-oss-120b` | 1.2s | 0 | Y | OK |
| `qwen3-30b-a3b-instruct-2507` | 0.2s | 0 | Y | OK |
| `qwen3-coder-next` | 0.2s | 0 | Y | OK |
| `qwen3-omni-30b-a3b-instruct` | 256.0s | 1 |  | ERR — Connection error. |
| `qwen3.5-122b-a10b` | 3.0s | 0 | Y | OK |
| `qwen3.5-397b-a17b` | 3.2s | 1 | Y | OK |
| `qwen3.6-27b` | 1.3s | 0 | Y | OK |
| `qwen3.6-35b-a3b` | 12.3s | 0 | Y | OK |
...
| `qwen3-embedding-4b` | 0.7s | 2560 | OK |
