...
> Auto-generiert von `gwdg probe` (gwdg-tools) — Stand **2026-08-17 07:03 UTC**.
...
| `deepseek-v4-flash-0731` | 0.3s | 0 | Y | OK |
...
| `qwen3-30b-a3b-instruct-2507` | 0.3s | 1 | Y | OK |
| `qwen3-coder-next` | 0.4s | 0 | Y | OK |
| `qwen3-omni-30b-a3b-instruct` | 283.4s | 0 |  | ERR — Connection error. |
| `qwen3.5-122b-a10b` | 2.4s | 0 | Y | OK |
| `qwen3.5-397b-a17b` | 12.0s | 0 | Y | OK |
| `qwen3.6-27b` | 4.9s | 0 | Y | OK |
| `qwen3.6-35b-a3b` | 1.4s | 0 | Y | OK |
...
| `qwen3-embedding-4b` | 0.6s | 2560 | OK |
